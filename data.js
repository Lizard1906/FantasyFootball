...
const trophies = [
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [68, 126, 181, 214, 267, 343, 409, 451, 515, 561, 617, 693, 781, 833, 881, 925, 1013, 1069, 1131, 1196, 1254, 1293, 1367, 1482, 1574, 1645, 1702] },
            { player: 2, color: 'green', evolution: [54, 122, 173, 242, 296, 352, 391, 436, 479, 517, 584, 629, 665, 710, 757, 809, 844, 895, 976, 1041, 1120, 1158, 1234, 1362, 1470, 1539, 1596] },
        ],
        finished: false
    },
    {
        id: 'en25draft', code: 'endraft', date: 2025, name: 'English Draft', category: 'en',
        data: [{ pos: 1, player: 1, V: 16, score: 1562 }, { pos: 2, player: 2, V: 11, score: 1351 }], 
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [95, 182, 259, 319, 391, 457, 540, 628, 727, 795] },
            { player: 2, color: 'green', evolution: [86, 149, 218, 311, 404, 463, 542, 637, 709, 794] },
        ],
        finished: false
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [22, 50, 87, 102, 143, 169, 185, 215, 252, 267] },
            { player: 2, color: 'green', evolution: [28, 51, 99, 122, 152, 177, 179, 212, 256, 266] },
        ],
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [    // vamos fingir que os playoffs so tiveram 1 jogo
            ...
            { player: 2, color: 'green', evolution: [47, 73, 108, 145, 194, 215, 253, 297, 322] },
        ],
        finished: false
    },
];
