...
const trophies = [
    ...
    // 2025-26
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution:   [41, 113, 178, 231, 269, 375, 424, 476, 553, 599, 656, 711, 751, 832, 881, 916, 997,  1058] },
            { player: 2, color: 'green', evolution: [57, 140, 204, 271, 321, 378, 431, 471, 527, 573, 614, 675, 717, 805, 864, 941, 1000, 1074] },
        ],
        finished: false
    },
    {
        ...
        standings: [
            { player: 0, predict: ["Porto", "Sporting", "Benfica", "Gil Vicente", "Braga", "Moreirense", "Famalicão", "Vitória SC", "FC Alverca", "Estoril", "Rio Ave", "Estrela", "Arouca", "Santa Clara", "Nacional", "Casa Pia", "Tondela", "AVS"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/primeira-liga-2/classificacao', update: '2026-01-19 21:49:02.348819'},
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red',  evolution: [56, 119, 155, 232, 259, 289, 347, 389, 455, 522, 576, 614, 666, 734, 785, 853, 952, 1013, 1049] },
            { player: 2, color: 'green', evolution: [43, 94, 146, 211, 255, 282, 361, 404, 444, 498, 530, 562, 600, 672, 710, 780, 871, 922, 950] },
        ],
        finished: false
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution:   [37, 70, 111, 197, 245, 245, 307, 364, 404, 468, 468, 517, 557, 615, 663, 711, 839, 889, 910] },
            { player: 2, color: 'green', evolution: [52, 92, 132, 132, 187, 237, 300, 359, 411, 477, 497, 524, 568, 650, 650, 671, 801, 834, 847] },
        ],
        finished: false
    },
    {
