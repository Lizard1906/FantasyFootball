...
const trophies = [
    ...
    // 2024-25
    {
        ...
        standings: [
            { player: 0, predict: ["Sporting CP", "SL Benfica", "FC Porto", "SC Braga", "Santa Clara", "Vitória SC", "Casa Pia AC", "FC Famalicão", "Estoril Praia", "Moreirense FC", "Rio Ave FC", "FC Arouca", "CD Nacional", "Gil Vicente FC", "Estrela Amadora", "AVS", "SC Farense", "Boavista FC"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/primeira-liga-2/classificacao', update: '2025-04-03 01:03:01.726324'},
        finished: false
    },
    {
