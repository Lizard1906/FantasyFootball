...
const trophies = [
    ...
    // 2025-26
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [41, 113, 178, 231, 269, 375, 424, 476] },
            { player: 2, color: 'green', evolution: [57, 140, 204, 271, 321, 378, 431, 471] },
        ],
        finished: false
    },
    {
        ...
        standings: [
            { player: 0, predict: ["Porto", "Sporting", "Benfica", "Gil Vicente", "Moreirense", "Famalicão", "Vitória SC", "Braga", "Nacional", "FC Alverca", "Arouca", "Rio Ave", "Santa Clara", "Casa Pia", "Estrela", "Estoril", "Tondela", "AVS"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/primeira-liga-2/classificacao', update: '2025-10-06 21:27:04.431104'},
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [56, 119, 155, 232, 259, 289, 347, 389] },
            { player: 2, color: 'green', evolution: [43, 94, 146, 211, 255, 282, 361, 404] },
        ],
        finished: false
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [37, 70, 111, 197, 245, 245, 307, 364] },
            { player: 2, color: 'green', evolution: [52, 92, 132, 132, 187, 237, 300, 359] },
        ],
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [118, 205, 271] },
            { player: 2, color: 'green', evolution: [94, 181, 282] },
        ],
        finished: false
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [73, 153, 207] },
            { player: 2, color: 'green', evolution: [55, 137, 199] },
        ],
        finished: false
    },
    {
    ...
    },
    {
        ...
        standings: [
            { player: 0, predict: ["PSG", "Bayern München", "Internazionale", "Arsenal", "Real Madrid", "Borussia Dortmund", "Manchester City", "Newcastle United", "Barcelona", "Liverpool", "Chelsea", "Sporting", "Qarabağ", "Galatasaray", "Tottenham Hotspur", "PSV", "Atalanta", "Olympique Marseille", "Atlético Madrid", "Club Brugge", "Athletic Club", "Eintracht Frankfurt", "Napoli", "Union Saint-Gilloise", "Juventus", "Bodø / Glimt", "Monaco", "Slavia", "Pafos", "Bayer Leverkusen", "Villarreal", "Copenhagen", "Olympiakos", "Kairat", "Benfica", "Ajax"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/uefa-champions-league-6/classificacao', update: '2025-10-23 22:30:22.690578'},
        finished: false
    },
