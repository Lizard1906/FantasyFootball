...
const trophies = [
    ...
    // 2024-25
    {
        ...
        standings: [
            { player: 0, predict: ["Sporting CP", "SL Benfica", "SC Braga", "FC Porto", "Vitória SC", "Santa Clara", "FC Famalicão", "Casa Pia AC", "Estoril Praia", "Moreirense FC", "Rio Ave FC", "FC Arouca", "CD Nacional", "Gil Vicente FC", "Estrela Amadora", "AVS", "Boavista FC", "SC Farense"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/primeira-liga-2/classificacao', update: '2025-04-29 22:31:07.426140'},
        finished: false
    },
    {
        id: 'en25', code: 'premier', date: 2025, name: 'Premier League', category: 'en',
        graph: [
            { player: 1, color: 'red', evolution: [68, 126, 181, 214, 267, 343, 409, 451, 515, 561, 617, 693, 781, 833, 881, 925, 1013, 1069, 1131, 1196, 1254, 1293, 1367, 1482, 1574, 1645, 1702, 1765, 1828, 1898, 1942, 2032, 2094] },
            { player: 2, color: 'green', evolution: [54, 122, 173, 242, 296, 352, 391, 436, 479, 517, 584, 629, 665, 710, 757, 809, 844, 895, 976, 1041, 1120, 1158, 1234, 1362, 1470, 1539, 1596, 1658, 1730, 1789, 1854, 1935, 1989] },
        ],
        finished: false
    },
    {
        id: 'en25draft', code: 'endraft', date: 2025, name: 'English Draft', category: 'en',
        data: [{ pos: 1, player: 1, V: 18, score: 1785 }, { pos: 2, player: 2, V: 14, score: 1571 }], 
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [95, 182, 259, 319, 391, 457, 540, 628, 727, 795, 852, 917, 1004, 1065] },
            { player: 2, color: 'green', evolution: [86, 149, 218, 311, 404, 463, 542, 637, 709, 794, 862, 940, 1044, 1107] },
        ],
        finished: false
    },
    {
        ...
        graph: [
            { player: 1, color: 'red', evolution: [22, 50, 87, 102, 143, 169, 185, 215, 252, 267, 292, 315, 373, 426] },
            { player: 2, color: 'green', evolution: [28, 51, 99, 122, 152, 177, 179, 212, 256, 266, 299, 349, 458, 501] },
        ],
        finished: false
    },
    {
    ...
    },
    {
        ...
        graph: [    // vamos fingir que os playoffs so tiveram 1 jogo
            { player: 1, color: 'red', evolution: [37, 37, 72, 109, 139, 165, 202, 233, 257, 295, 356, 470] },
            { player: 2, color: 'green', evolution: [47, 73, 108, 145, 194, 215, 253, 297, 322, 360, 439, 546] },
        ],
        finished: false
    },
    {
