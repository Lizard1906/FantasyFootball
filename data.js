...
const trophies = [
    ...
    // 2024-25
    {
        ...
        standings: [
            { player: 0, predict: ["Sporting CP", "SL Benfica", "FC Porto", "SC Braga", "Santa Clara", "Vitória SC", "Casa Pia AC", "Estoril Praia", "FC Famalicão", "Rio Ave FC", "Moreirense FC", "FC Arouca", "CD Nacional", "Gil Vicente FC", "AVS", "Estrela Amadora", "SC Farense", "Boavista FC"]},
        ...
        source: {name: 'SAPO Desporto', url: 'https://desporto.sapo.pt/futebol/competicao/primeira-liga-2/classificacao', update: '2025-03-13 15:00:10.021681'},
        finished: false
    },
    {
